<template>
  <div :class="classes">
    <!-- <h3 class="o1-text-gray-600 dark:o1-text-gray-400 o1-mb-4">{{ field.name }}</h3> -->
    <NoteInput
  ...
  computed: {
    ...
    classes() {
      const defaultClasses =
        'notes-field o1-bg-gray-100 dark:o1-bg-gray-800 o1-px-4 o1-pt-4 o1-pb-2 o1-rounded-b-lg o1-border-b o1-border-gray-200 dark:o1-border-gray-700';
